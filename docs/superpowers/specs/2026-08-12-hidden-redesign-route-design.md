...
The initial redesign page contains only an empty `main` element sized to the viewport. It introduces no copy, controls, design system, or placeholder layout, leaving future design decisions unconstrained.
